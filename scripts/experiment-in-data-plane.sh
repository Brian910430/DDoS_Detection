...
WAIT_FOR_SWITCH_START=25 # Seconds to wait for switch to start (incl. program compilation)
# Recommended values:
...
WAIT_FOR_SWITCH_FINISH=20 # Seconds to wait for switch to finish forwarding packets before killing p4run
